...
public class Dashboard extends Fragment {
    ...
    Report report;
    Integer IncomeBalance, ExpenseBalance;
    Integer balence;
    String Dyear = "", Dmonth = "";
        ...
        dashboardSubmitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (amountTxt.isEmpty() || amountTxt.trim().equals("") || sourceName.isEmpty()) {
                    Toast.makeText(getContext(), "সকল তথ্য দিন", Toast.LENGTH_SHORT).show();
                } else {
...
/// Total income button
    ...
    public void insertdata(int amount, String sourceName, String calculationType, String date) {
        ...
        if (row > 0) {
            Toast.makeText(getContext(), "তথ্য সংরক্ষন সফল হয়েছে", Toast.LENGTH_SHORT).show();
            dashboardAddAmount.setText("");
            dashboardAddSource.setText("");

        } else {
            Toast.makeText(getContext(), "তথ্য সংরক্ষন ব্যার্থ", Toast.LENGTH_SHORT).show();
    ...
    public void Balance() {
        ...
        balence = IncomeBalance - ExpenseBalance;
        balanceShow.setText("" + balence);
