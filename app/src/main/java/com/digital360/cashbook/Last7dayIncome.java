...
public class Last7dayIncome extends AppCompatDialogFragment {
    View view;
    String Titel="গত ৭ দিনের ইনকামের তালিকা";
    GridView gridView;
    Dashboard dashboard;
    String[] row;
    int k;
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        date1 = (currentDay-1) + "/" + currentMonth + "/" + currentYear;
        date2 = (currentDay-2) + "/" + currentMonth + "/" + currentYear;
        date3 = (currentDay -3)+ "/" + currentMonth + "/" + currentYear;
        date4 = (currentDay -4)+ "/" + currentMonth + "/" + currentYear;
        date5 = (currentDay -5)+ "/" + currentMonth + "/" + currentYear;
        date6 = (currentDay-6) + "/" + currentMonth + "/" + currentYear;
        date7 = (currentDay -7) + "/" + currentMonth + "/" + currentYear;


        cursor = database.find7Day(date1,date2,date3,date4,date5,date6,date7,"ইনকাম");
        row = new String[3];
