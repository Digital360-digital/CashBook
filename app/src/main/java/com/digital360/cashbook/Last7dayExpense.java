...
public class Last7dayExpense extends AppCompatDialogFragment {
    View view;
    String Titel="গত ৭ দিনের খরচের তালিকা";
    GridView gridView;
    Dashboard dashboard;
    String[] row;
    int k;
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        cursor = database.find7Day(date1,date2,date3,date4,date5,date6,date7,"খরচ");
        row = new String[3];
