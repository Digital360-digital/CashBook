...
public class Database extends SQLiteOpenHelper {
    ...
    private static final String DELETE="DELETE  FROM "+USER_TABLE;
    ...
    private static final String INCOME_QUERY="SELECT   "+DATE+" , "+AMOUNT+" , "+SOURCE_NAME+"  FROM "+DAILY_DOCUMENT_TABLE+" WHERE "+CALCULATION_TYPE+" = 'ইনকাম' ;";
    private static final String EXPENSE_QUERY="SELECT  "+DATE+" , "+AMOUNT+" , "+SOURCE_NAME+"  FROM "+DAILY_DOCUMENT_TABLE+" WHERE "+CALCULATION_TYPE+" = 'খরচ' ;";
    private static final String TAKE_LOAN_QUERY="SELECT  "+DATE+" , "+AMOUNT+" , "+SOURCE_NAME+"  FROM "+DAILY_DOCUMENT_TABLE+" WHERE "+CALCULATION_TYPE+" = 'ঋন গ্রহন' ;";
    private static final String GIVE_LOAN_QUERY="SELECT  "+DATE+" , "+AMOUNT+" , "+SOURCE_NAME+"  FROM "+DAILY_DOCUMENT_TABLE+" WHERE "+CALCULATION_TYPE+" = 'ঋন প্রদান' ;";
    private static final String RETURN_LOAN_QUERY="SELECT  "+DATE+" , "+AMOUNT+" , "+SOURCE_NAME+"  FROM "+DAILY_DOCUMENT_TABLE+" WHERE "+CALCULATION_TYPE+" = 'প্রদানকৃত ঋন ফেরত' ;";
    private static final String PAID_LOAN_QUERY="SELECT  "+DATE+" , "+AMOUNT+" , "+SOURCE_NAME+"  FROM "+DAILY_DOCUMENT_TABLE+" WHERE "+CALCULATION_TYPE+" = 'গ্রহনকৃত ঋন পরিশোধ' ;";
